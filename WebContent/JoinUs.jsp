  ...
  <body>
	...
	<div class="container">	
				...
				<div class="col-lg-9 col-lg-offset-2 centered">
					<img src="assets/img/logo_black.png" alt="Stanley" style="width:700px;">
					<h1 style="margin-top:-150px;padding-right:100px; font-size:21px !important">If you're interested in becoming an Advisor with us, 
					just leave us a message with your name, number and email address <a href="contactus">here</a> and we'll get 
					back to you in no time!</h1>
				</div><!-- /col-lg-8 -->
			</div><!-- /row -->
	</div>
	<div style="margin-left:5.9%;margin-right:5.9%">
