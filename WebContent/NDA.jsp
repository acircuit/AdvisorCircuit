...
<html lang="en">
  <head>
    ...
    <meta name="description" content="Advisor | User | Non-Disclosure Agreement">
    <meta name="author" content="">
    <fmt:bundle basename="Resources.Dependency" prefix="path.">
  		 <link rel="shortcut icon" href=<fmt:message key="shortcuticon"/>>	
  	</fmt:bundle>

    <title>Non-Disclosure Agreement | Advisor Circuit</title>
  ...
  <div class="container">
	...
	<div class="term-page content">
		...
		<ol>
			<li>Advisor Circuit, (the "Disclosing Party"); and</li>
			<li>Advisor, (the "Receiving Party"),</li>
		</ol>
		<p>Collectively referred to as the 'Parties'.</p>
		<h3>RECITALS</h3>
		<p>The Receiving Party understands that the Disclosing Party has disclosed or may disclose information relating to Business proposal,
		 Financials, Market Analysis, Products offering, Pricing & Competition, which to the extent previously, presently, or subsequently disclosed
		  to the Receiving Party is hereinafter referred to as "Proprietary Information" of the Disclosing Party.</p>
		...
		<ol>
			...
			<li>This Agreement shall be governed by the laws of the jurisdiction in New Delhi (in which the Disclosing Party is located) and the parties agree to submit disputes arising out of or in connection with this Agreement to the non-exclusive of the courts in New Delhi.</li>
		</ol>
	</div>
	<!--end-->
	</fmt:bundle>	
