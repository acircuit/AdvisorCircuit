                 ...
                 <div class="panel-body" >
	               <form id="signupform" class="form-horizontal" role="form" action="usermyaccount" method="post" enctype="multipart/form-data" >
		            ...
		            <div class="form-group" id="demail">
	                  ...
	                  <div class="col-md-5">
	                      <input id="email" type="text" class="form-control" name="email" placeholder="Email" value="${profile.getEmail()}" maxlength="100">
	                  </div>
	                  <div class="col-md-2">
	                      <p class="required" id="required_email">Field Required</p>
	                      <p class="required" id="invalid_email">Invalid Email</p>
	                  </div>
	              </div>
