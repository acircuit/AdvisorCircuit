					...
					<form id="signupform" class="form-horizontal" role="form" action="AdvisorMyAccountSessionViewDetailsFormController" >
                        ...
                        <div class="form-group">
                            <div class="col-lg-12">
                                ...
                                <tr><th>Duration</th><td>:</td><td><c:out value="${request.getDuration()}"></c:out> Hour </td></tr>
                        ...
                        <c:set var="rId" value="${request.getRequestId()}"></c:set>
                           <c:if test="${request.getService().equals('mockinterview') || request.getService().equals('cvcritique')}">
                           		<h4><a href="DownloadFile?rid=${rId}">CLICK TO DOWNLOAD CV UPLOADED BY YOU</a></h4>
                           </c:if> 
                        <hr>
                        ...
                        <c:if test="<%= path != null && path.length()>5 %>">
                            <div class="form-group">
                                ...
                                <c:if test="${request.getService().equals('cvcritique')}">
                                    <div class="col-md-10">
                                        <h4><a href="DownloadFile?path=<%=path%>">Resume Critique Feedback Form </a></h4>
                                    </div>
                                </c:if>
                                <c:if test="${request.getService().equals('mockinterview')}">
                                    <div class="col-md-10">
                                        <h4><a href="DownloadFile?path=<%=path%>">Mock Interview Feedback Form </a></h4>
                                    </div>
                                </c:if>
                            </div>
                        </c:if>	
                                ...
                                <div class="form-group">
                                    ...
                                    <label for="icode" class="col-md-3 control-label" style="text-align:left"><a data-toggle="modal" data-target="#modephone">View Details</a></label>	
                                    </c:if>
                                    <c:if test="${!fromPreviousSession && !fromCancelledSession && request.getMode().equals('webchat') && details != null && !details.equals('')}">
                                    <label for="icode" class="col-md-3 control-label" style="text-align:left"><a data-toggle="modal" data-target="#modewebchat">View Details</a></label>	
                                    </c:if>			
                                </div>
										...
										<div class="modal-dialog modal-lg">
											<div class="modal-content">
												...
												<div class="modal-body">
				                              	<ol>
													<li>Please dial a number suitable to you from the list.<a href=<fmt:message key="enterprise_list"/>>DownLoad List</a>
													</li> 
								...
								<div class="modal fade" id="modewebchat" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
											<div class="modal-dialog modal-lg">
												<div class="modal-content">
													...
													<div class="modal-body">
					                              	<ol>
					                              		<li>Please sign into your gmail account through which you can use hangouts</li>
														<li>After you are signed in, click/ copy paste this link : <%=details %> in your browser to join the video call</li>
													</ol>  
													</div>
												</div>
											</div>
						...
						<c:choose>
                                ...
                                <c:if test="${request.getMode().equals('email') && !fromCancelledSession || fromPreviousSession && request.getMode().equals('email') }">
                                	<a class="btn btn-info margin-10" data-toggle="modal" data-target="#email" onclick="">Send Your Mail</a>
                                </c:if>
                                
                                <c:if test="${(!fromCancelledSession && visible) || fromPreviousSession}">
                                    <a class="btn btn-info margin-10" data-toggle="modal" data-target="#feedback" onclick="">Follow Up Mail</a>
                                </c:if>
			...
			<div class="modal fade" id="feedback" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
				<div class="modal-dialog modal-lg">
					<div class="modal-content">
						...
						<div class="modal-body">
							<form id="sendfeedback" class="form-horizontal" role="form" enctype="multipart/form-data"  method="post">
                                <c:choose>
                                	<c:when test="${feedbackUser.getId() != 0 }">
			                                ...
			                                <hr>
							<c:choose>
			                                <c:when test="<%=!isFeedBackRejected &&  (fromPreviousSession == null || !fromPreviousSession)%>">
			                                		 <div class="form-group">
				                                    <label for="icode" class="col-md-3 control-label">Subject</label>
				                                    <div id = "feedbacksubject" class="col-md-9">
														<input type="text" id="subject" name="subject" style="width: 80%" value="${feedbackUser.getUserSubject()}" >
				                                    </div>
				                                </div>
				                                <div class="form-group">
				                                ...
				                                <c:if test="${!feedbackUser.getUserFile().equals('') && feedbackUser.getUserFile() != null }">
					                                 <div class="form-group">
															<label for="icode" class="col-md-3 control-label"></label>
															<div class="col-md-9">
																<h4  style="float: right;"><a href="DownloadFile?path=${feedbackUser.getUserFile()}">CLICK TO DOWNLOAD FILE</a></h4>
															</div>
													</div>
												</c:if>
                                            	...
                                            	<div id="responsefeedback">
	                                             ...
	                                             <div class="form-group">
	                                                <!-- Button -->                                        
	                                                <div class="col-md-offset-2 col-md-10">
	                                                    <input id="btn-signup" type="button" onclick="sendfeedbackagain()" class="btn btn-info" value="Send">
	                                                </div>
	                                            </div>
			                                ...
			                                <c:otherwise>
				                                    ...
				                                    <label for="icode" class="col-md-3 control-label">Subject</label>
				                                    <div id = "feedbacksubject" class="col-md-9">
														<input type="text" id="subject" name="subject" style="width: 80%" value="${feedbackUser.getUserSubject()}" readonly="readonly">
				                                    </div>
				                                </div>
				                                <div class="form-group">
				                                    <label for="icode" class="col-md-3 control-label">Body</label>
				                                    <div id = "feedbackbody" class="col-md-9" style="width: 100px">
				                                    	<textarea rows="15" cols="90" id="body"  name="body" readonly="readonly">${feedbackUser.getUserBody()}</textarea>                                   
				                                    </div>
				                                </div>
				                                <c:if test="${!feedbackUser.getUserFile().equals('') && feedbackUser.getUserFile() != null }">
					                                 <div class="form-group">
                                	...
                                	<c:otherwise>
                                		...
                                		<div class="form-group text-left">
                                            ...
                                            <div id = "feedbacksubject" class="col-md-10">
                                                <input type="text" id="subject" name="subject"  style="width:100%" maxlength="350">
                                            </div>
	                                	</div>
                                        <div class="form-group text-left">
                                            <label for="icode" class="col-md-2 control-label">Body</label>
                                            <div id = "feedbackbody" class="col-md-10">
                                                <textarea rows="10" id="body"  name="body"  style="width:100%" maxlength="3000"></textarea>                                   
                                            </div>
                                        </div>
	                                 <div class="form-group text-left">
	                                    <label for="icode" class="col-md-2 control-label">Attach File</label>
									...
									<c:if test="${!fromPreviousSession}">
										 <div class="form-group">
		                                    ...
		                                    <div class="col-md-offset-3 col-md-9">
		                                    	<input id="btn-feed" type="button" onclick="sendfeedback()" class="btn btn-info" value="Send">
		                                    </div>
		                                </div>
	                                </c:if>
	                                </div><!--part2-->	
										 ...
										 <div id="part2">
			                                ...
			                                <hr>
				                                <div class="form-group">
				                                    <label for="icode" class="col-md-3 control-label">Subject</label>
				                                    <div id = "feedbacksubject" class="col-md-9">
														<input type="text" id="subject" name="subject" readonly="readonly"  style="width: 80%" value="${feedAdvisor.getAdvisorSubject()}">
				                                    </div>
				                                </div>
				                                <div class="form-group">
				                                    <label for="icode" class="col-md-3 control-label">Body</label>
				                                    <div id = "feedbackbody" class="col-md-9" style="width: 100px">
				                                    	<textarea rows="15" cols="90" id="body" readonly="readonly" name="body">${feedAdvisor.getAdvisorBody()}</textarea>                                   
				                                    </div>
				                                </div>
				                                 <c:if test="${!feedAdvisor.getAdvisorFile().equals('') && feedAdvisor.getAdvisorFile() != null}">
					                                 <div class="form-group">
															<label for="icode" class="col-md-3 control-label"></label>
															<div class="col-md-9">
																<h4  style="float: right;"><a href="DownloadFile?path=${feedAdvisor.getAdvisorFile()}">CLICK TO DOWNLOAD FILE</a></h4>
															</div>
													</div>
												</c:if>
			...
			<div class="modal fade" id="email" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
				<div class="modal-dialog modal-lg">
					<div class="modal-content">
						...
						<div class="modal-body">
							<form id="sendemail" class="form-horizontal" role="form" enctype="multipart/form-data"  method="post">
                                <c:choose>
                                	<c:when test="${emailUser != null && emailUser.getId() != 0 }">
                                			<div id="part2">
											<h4>Your Mail : <span style="color: #c84c4e">(After pressing send, please don't close the window till you see the message - 'Your mail has been sent')</span></h4>
			                                <hr>
			                                <c:choose>
			                                <c:when test="<%=isEmailRejected != null && !isEmailRejected &&  (fromPreviousSession == null || !fromPreviousSession)%>">
			                                		<div class="form-group">
				                                    <label for="icode" class="col-md-3 control-label">Subject</label>
				                                    <div id = "emailsubject" class="col-md-9">
														<input type="text" id="subjectemail" name="subject" style="width: 80%" value="${emailUser.getUserSubject()}" maxlength="350">
				                                    </div>
				                                </div>
				                                <div class="form-group">
				                                    <label for="icode" class="col-md-3 control-label">Body</label>
				                                    <div id = "emailbody" class="col-md-9" style="width: 100px">
				                                    	<textarea rows="15" cols="90" id="bodyemail"  name="body" maxlength="3000">${emailUser.getUserBody()}</textarea>                                   
				                                    </div>
				                                </div>
				                                <c:if test="${!emailUser.getUserFile().equals('') && emailUser.getUserFile() != null }">
					                                 <div class="form-group">
															<label for="icode" class="col-md-3 control-label"></label>
															<div class="col-md-9">
																<h4  style="float: right;"><a href="DownloadFile?path=${emailUser.getUserFile()}">CLICK TO DOWNLOAD FILE</a></h4>
															</div>
													</div>
												</c:if>
												<div class="form-group text-left">
                                            	...
                                            	<div id="responseemail">
	                                             ...
	                                             <div class="form-group">
	                                                <!-- Button -->                                        
	                                                <div class="col-md-offset-2 col-md-10">
	                                                    <input id="btn-signup" type="button" onclick="resendemailagain()" class="btn btn-info" value="Send">
	                                                </div>
	                                            </div>
			                                </c:when>
			                                <c:otherwise>
				                                    ...
				                                    <label for="icode" class="col-md-3 control-label">Subject</label>
				                                    <div id = "emailsubject" class="col-md-9">
														<input type="text" id="subjectemail" readonly="readonly" name="subject" style="width: 80%" value="${emailUser.getUserSubject()}">
				                                    </div>
				                                </div>
				                                <div class="form-group">
				                                    <label for="icode" class="col-md-3 control-label">Body</label>
				                                    <div id = "emailbody" class="col-md-9" style="width: 100px">
				                                    	<textarea rows="15" cols="90" id="bodyemail" readonly="readonly" name="body" >${emailUser.getUserBody()}</textarea>                                   
				                                    </div>
				                                </div>
				                                <c:if test="${!emailUser.getUserFile().equals('') && emailUser.getUserFile() != null }">
					                                 <div class="form-group">
                                	...
                                	<c:otherwise>
                                		...
                                		<div class="form-group text-left">
                                            ...
                                            <div id = "emailsubject" class="col-md-10">
                                                <input type="text" id="subjectemail" name="subject"  style="width:100%" maxlength="350">
                                            </div>
	                                	</div>
                                        <div class="form-group text-left">
                                            <label for="icode" class="col-md-2 control-label">Body</label>
                                            <div id = "emailbody" class="col-md-10">
                                                <textarea rows="10" id="bodyemail"  name="body"  style="width:100%" maxlength="3000"></textarea>                                   
                                            </div>
                                        </div>
	                                 <div class="form-group text-left">
	                                    <label for="icode" class="col-md-2 control-label">Attach File</label>
									...
									<c:if test="${!fromPreviousSession}">
										 <div class="form-group">
		                                    <!-- Button -->                                        
		                                    <div class="col-md-offset-3 col-md-9">
		                                    	<input id="btn-feed" type="button" onclick="sendemail()" class="btn btn-info" value="Send">
		                                    </div>
		                                </div>
	                                </c:if>
	                                </div><!--part2-->	
                                ...
                                <c:if test="${emailAdvisor != null && emailAdvisor.getId() != 0 }">
                                		<hr>																	 
										 <div id="part2">
											<h4>Advisor Mail :</h4>
			                                <hr>
				                                <div class="form-group">
				                                    <label for="icode" class="col-md-3 control-label">Subject</label>
				                                    <div id = "feedbacksubject" class="col-md-9">
														<input type="text" id="subject" name="subject" readonly="readonly"  style="width: 80%" value="${emailAdvisor.getAdvisorSubject()}">
				                                    </div>
				                                </div>
				                                <div class="form-group">
				                                    <label for="icode" class="col-md-3 control-label">Body</label>
				                                    <div id = "feedbackbody" class="col-md-9" style="width: 100px">
				                                    	<textarea rows="15" cols="90" id="body" readonly="readonly"  name="body">${emailAdvisor.getAdvisorBody()}</textarea>                                   
				                                    </div>
				                                </div>
				                                 <c:if test="${!emailAdvisor.getAdvisorFile().equals('') && emailAdvisor.getAdvisorFile() != null}">
					                                 <div class="form-group">
															<label for="icode" class="col-md-3 control-label"></label>
															<div class="col-md-9">
																<h4  style="float: right;"><a href="DownloadFile?path=${emailAdvisor.getAdvisorFile()}">CLICK TO DOWNLOAD FILE</a></h4>
															</div>
													</div>
												</c:if>
				                                <div id="responsefeedbackadvisor">
