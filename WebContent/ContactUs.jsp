				...
				<div class="row">
					<div class="col-lg-6">
                        <div class="form-group col-lg-12" id="dfname">
                            <label>Name</label>
                            <input id="fname" type="text" name="name" class="form-control" style="width:100%" maxlength="80">
                        </div>
                        ...
                        <div class="form-group col-lg-12">
                            ...
                            <input id="email" type="email" name="email" class="form-control" style="width:100%" required="required" maxlength="150">
                        </div>
