		...
		if(fileId != null && status != null){
			...
			if(isStatusCommit){
				if(status.equals("REJECTED")){
					...
					content = "Hi,<br>We are sorry but your communication has been rejected.For further information please contact <b>Advisor Circuit@</b>contactus@advisorcircuit.com<br><h3>File Purpose : </h3>" +comment+"<br><img src=\"http://www.advisorcircuit.com/Test/assets/img/logo_black.png\" style='float:right' width='25%'>";
				...
				if(isStatusCommit1){
					if(status.equals("REJECTED")){
						...
						String content ="";
						subject = "Your Communication has been rejected";
						content = "Hi,<br>We are sorry but your communication has been rejected.For further information please contact <b>Advisor Circuit@</b>contactus@advisorcircuit.com<br><h3>Message : </h3>" +userMessage+"<br><img src=\"http://www.advisorcircuit.com/Test/assets/img/logo_black.png\" style='float:right' width='25%'>";
						SendMail mail = new SendMail(subject, content, email ,"admin@advisorcircuit.com");
						mail.start();
							response.getWriter().write("THE STATUS HAS BEEN CHANGED.PLEASE REFRESH THE PAGE");
					}
				...
				if(isStatusCommit1){
					if(status.equals("REJECTED")){
						...
						String content ="";
						subject = "Your Communication has been rejected";
						content = "Hi,<br>We are sorry but your communication has been rejected.For further information please contact <b>Advisor Circuit@</b>contactus@advisorcircuit.com<br><h3>Message : </h3>" +advisorMessage+"<br><img src=\"http://www.advisorcircuit.com/Test/assets/img/logo_black.png\" style='float:right' width='25%'>";
						SendMail mail = new SendMail(subject, content,email ,"admin@advisorcircuit.com");
						mail.start();
							response.getWriter().write("THE STATUS HAS BEEN CHANGED.PLEASE REFRESH THE PAGE");
						}
