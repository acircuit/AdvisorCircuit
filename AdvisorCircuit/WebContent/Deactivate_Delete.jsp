              ...
              <div class="panel panel-info">
                   ...
                   <div class="panel-body" >
                               ...
                               <div class="col-md-offset-3 col-md-9">
                               		<a href="DeactivateAdvisor?aId=<%=aId %>" id="btn" class="btn btn-info">Deactivate</a>
                               </div>
                           		<span style="margin-left: 170px"><b>OR</b></span>
                               <!-- Button -->                                        
                               <div class="col-md-offset-3 col-md-9">
                               		 <a href="/Tomact_7/DeleteAdvisorController?aId=<%=aId %>" id="btn" class="btn btn-info">Delete</a>
                               </div>
                    </div>
                 </div> 
         </div> 
