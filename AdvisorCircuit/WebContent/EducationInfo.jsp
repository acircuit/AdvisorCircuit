                                ...
                                <c:if test="${edu.getType().equals('UG')}">
                                    <div class="form-group" id="dunder">
                                        <label for="icode" class="col-md-3 control-label">Undergraduate</label>
                                            <div class="col-md-5">
                                                 <input id="under" name="ug" class="form-control" maxlength="100" value="${edu.getEducation()}"></input>
                                            </div>
                                        <div class="col-md-2">
                                ...
                                <c:if test="${edu.getType().equals('PG')}">		                                                                    			
                                     <div class="form-group" id="dpost">
                                        <label for="icode" class="col-md-3 control-label">Post Graduate</label>
                                            <div class="col-md-5">
                                               <input id="post" name="pg" class="form-control" maxlength="100" value="${edu.getEducation()}"></input>  
                                            </div>
                                    </div>
                                </c:if>
                                <c:if test="${edu.getType().equals('OTHERS')}">
                                     <div class="form-group" id="dother" >
                                        <label for="icode" class="col-md-3 control-label">Any other</label>
                                            <div class="col-md-5">
                                            <input id="other" name="others[]" class="form-control" maxlength="100" value="${edu.getEducation()}"></input>
                                            </div>
                                    </div>
                               </c:if>
                              </c:forEach>
                        ...
                        <c:otherwise>
                            <div id="education">
                                <div class="form-group" id="dunder">
                                    <label for="icode" class="col-md-3 control-label">Undergraduate</label>
                                    <div class="col-md-5">
                                         <input id="under" name="ug" class="form-control" maxlength="100"></input>
                                    </div>
                                    <div class="col-md-2">
                                        <p class="required" id="required_name">Field Required</p>																		
                                    </div>
                                 ...
                                 <div class="form-group" id="dpost">
                                    <label for="icode" class="col-md-3 control-label">Post Graduate</label>
                                    <div class="col-md-5">
                                       <input id="post" name="pg" class="form-control" maxlength="100"></input>  
                                    </div>
                                </div>
                                 <div class="form-group" id="dother" >
                                    <label for="icode" class="col-md-3 control-label">Any other</label>
                                    <div class="col-md-5">
                                    <input id="other" name="others[]" class="form-control" maxlength="100"></input>
                                    </div>
                                </div>
                              </div>
                              <div class="row">
