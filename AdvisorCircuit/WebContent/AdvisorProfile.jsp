							...
							<div class="modal-content">
                                ...
                                <div class="form-group">
                                    <label for="icode" style="font-family:'custom_light' !important;" class="col-md-3 control-label">Services</label>
                                     <div class="col-md-6">
										<select class="form-control" id="services_dropdown" style="font-family:'custom_light' !important;" name="services_dropdown" onchange="setDate()" >
								...
								<hr>
								 ...
								 <div class="form-group">
										...
										<div id="datetimepicker1" class="input-append date" >
										  <input type="datetime" style="font-family:'custom_light' !important;" id="datepicker1" name="datetimepicker1" ></input>
										  <span class="add-on">
								...
								<div class="form-group">
										...
										<div id="datetimepicker2" class="input-append date" >
										  <input type="datetime" style="font-family:'custom_light' !important;" id="datepicker2" name="datetimepicker2"></input>
										  <span class="add-on">
											<i data-time-icon="icon-time" data-date-icon="icon-calendar" style="margin-top:7px"></i>
										  </span>
										</div>
								...
								<div class="form-group">
										...
										<div id="datetimepicker3" class="input-append date" >
										  <input type="datetime" style="font-family:'custom_light' !important;" id="datepicker3" name="datetimepicker3"></input>
										  <span class="add-on">
											<i data-time-icon="icon-time" data-date-icon="icon-calendar" style="margin-top:7px"></i>
										  </span>
										</div>
								...
								<div class="form-group">
										...
										<div id="datetimepicker4" class="input-append date">
										  <input type="datetime" style="font-family:'custom_light' !important;" id="datepicker4" name="datetimepicker4"></input>
										  <span class="add-on">
											<i data-time-icon="icon-time" data-date-icon="icon-calendar" style="margin-top:7px"></i>
										  </span>
										</div>
								...
								<div class="form-group">
										...
										<div id="datetimepicker5" class="input-append date">
										  <input type="datetime" style="font-family:'custom_light' !important;" id="datepicker5" name="datetimepicker5"></input>
										  <span class="add-on">
											<i data-time-icon="icon-time" data-date-icon="icon-calendar" style="margin-top:7px"></i>
										  </span>
										</div>
								...
								<div class="form-group">
										...
										<div id="datetimepicker6"  class="input-append date">
										  <input type="datetime" style="font-family:'custom_light' !important;" id="datepicker6" name="datetimepicker6"></input>
										  <span class="add-on">
											<i data-time-icon="icon-time" data-date-icon="icon-calendar" style="margin-top:7px"></i>
										  </span>
										</div>
								...
								<div id="emailslot" style="display: none">
									...
									<div class="form-group">
											...
											<div id="datetimepickeremail" class="input-append date" >
											  <input type="datetime" style="font-family:'custom_light' !important;" id="datepickeremail" name="datetimepickeremail" data-provide="datepicker"  class="datepicker" ></input>
											  <span class="add-on">
												<i data-time-icon="icon-time" data-date-icon="icon-calendar" style="margin-top:7px"></i>
											  </span>
											</div>
								...
								<div class="form-group">
                                    <label for="icode" style="font-family:'custom_light' !important;" class="col-md-3 control-label">Enter Your Query :</label>
                                    <div class="col-md-6">
