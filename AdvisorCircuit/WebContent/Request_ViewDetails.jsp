                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-10">
										...
										<c:choose>
											...
											<div id="collapseOne" class="panel-collapse collapse">
												 <div class="form-group">
                                                    ...
                                                    <div id="datetimepicker1" class="input-append date col-md-10">
                                                      <input id="datepicker1" type="datetime" name="datetimepicker1" style="float:left;"></input>
												...
												<div class="form-group">
                                                    ...
                                                    <div id="datetimepicker2" class="input-append date col-md-10">
                                                      <input id="datepicker2" type="datetime" name="datetimepicker2" style="float:left;"></input>
                                                      <span class="add-on" style="float:left;">
                                                        <i data-time-icon="icon-time" data-date-icon="icon-calendar" style="margin-top:7px"></i>
                                                      </span>
                                                    </div>
												...
												<div class="form-group">
                                                    ...
                                                    <div id="datetimepicker3" class="input-append date col-md-10">
                                                      <input id="datepicker3" type="datetime" name="datetimepicker3" style="float:left;"></input>
                                                      <span class="add-on" style="float:left;">
                                                        <i data-time-icon="icon-time" data-date-icon="icon-calendar" style="margin-top:7px"></i>
                                                      </span>
                                                    </div>
											...
											<div class="form-group">
												<div class="col-md-12">
													<textarea class="form-control" id="sessionplan" rows="4" name="sessionplan" placeholder="Write Session Plan" style="width:90%;"></textarea>
												</div>
											</div>
											<hr>
										</c:if>
