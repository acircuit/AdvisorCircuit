                    ...
                    <div class="panel-body">
                        <form id="signupform" class="form-horizontal" role="form" action="AdvisorMyAccountSessionViewDetailsFormController" >
                            ...
                            <c:if test="${request.getService().equals('mockinterview') || request.getService().equals('cvcritique')}">
                            	<h4><a href="DownloadFile?rid=${rId}">CLICK TO DOWNLOAD <%=userName.toUpperCase() %>'s CV</a></h4>
                            </c:if>
                            ...
                            <c:if test="${ fromPreviousSession && request.getMode().equals('email') || !fromCancelledSession && emailUser.getId() != 0}">
                                <h4><a data-toggle="modal" data-target="#email" onclick="">User's Mail</a></h4>                            
                            </c:if>
                            
                            <c:if test="${ fromPreviousSession || !fromCancelledSession && feedUser.getId() != 0}">
                                <h4><a data-toggle="modal" data-target="#feedback" onclick="">User's Follow Up Mail</a></h4>
                            </c:if>
                                ...
                                <div class="modal-body">
								 ...
								 <c:choose>
			                                        <c:when test="<%=!isRejectedFeedback && (fromPreviousSession == null || !fromPreviousSession)  %>">
			                                                ...
			                                                <label for="icode" class="col-md-2 control-label">Subject</label>
			                                                <div id = "feedbacksubject" class="col-md-10">
			                                                    <input type="text" id="advisorsubject" name="subject"  style="width:100%" value="${feedAdvisor.getAdvisorSubject()}">
			                                                </div>
			                                            </div>
			                                            <div class="form-group">
			                                                <label for="icode" class="col-md-2 control-label">Body</label>
			                                                <div id = "feedbackbody" class="col-md-10">
			                                                    <textarea rows="10" id="advisorbody"  name="body" style="width:100%;">${feedAdvisor.getAdvisorBody()}</textarea>                                   
			                                                </div>
			                                            </div>
                                     		...
                                     		<c:otherwise>
		                                        ...
		                                        <c:if test="${(!fromPreviousSession)}">
		                                            <div class="form-group">
		                                                <label for="icode" class="col-md-2 control-label">Subject</label>
		                                                <div id = "feedbacksubject" class="col-md-10">
		                                                    <input type="text" id="advisorsubject" name="subject"  style="width:100%">
		                                                </div>
		                                            </div>
		                                            <div class="form-group">
		                                                <label for="icode" class="col-md-2 control-label">Body</label>
		                                                <div id = "feedbackbody" class="col-md-10">
		                                                    <textarea rows="10" id="advisorbody"  name="body"  style="width:100%;"></textarea>                                   
		                                                </div>
		                                            </div>
		                                             <div class="form-group">
		                                                <label for="icode" class="col-md-2 control-label">Attach File</label>
                                     ...
                                     <c:choose>
                                     		<c:when test="${!emailAdvisor.getAdvisorSubject().equals('') && emailAdvisor.getAdvisorSubject() != null && !emailAdvisor.getAdvisorBody().equals('') &&  emailAdvisor.getAdvisorBody()!=null  }">
			                                        ...
			                                        <c:when test="<%=!isRejectedMail && (fromPreviousSession == null || !fromPreviousSession)  %>">
			                                                ...
			                                                <label for="icode" class="col-md-2 control-label">Subject</label>
			                                                <div id = "feedbacksubject" class="col-md-10">
			                                                    <input type="text" id="advisorsubjectemail" name="subject"  style="width:100%" value="${emailAdvisor.getAdvisorSubject()}">
			                                                </div>
			                                            </div>
			                                            <div class="form-group">
			                                                <label for="icode" class="col-md-2 control-label">Body</label>
			                                                <div id = "feedbackbody" class="col-md-10">
			                                                    <textarea rows="10" id="advisorbodyemail"  name="body" style="width:100%;">${emailAdvisor.getAdvisorBody()}</textarea>                                   
			                                                </div>
			                                            </div>
                                     		...
                                     		<c:otherwise>
		                                        ...
		                                        <c:if test="${(!fromPreviousSession)}">
		                                            <div class="form-group">
		                                                <label for="icode" class="col-md-2 control-label">Subject</label>
		                                                <div id = "feedbacksubject" class="col-md-10">
		                                                    <input type="text" id="advisorsubjectemail" name="subject"  style="width:100%">
		                                                </div>
		                                            </div>
		                                            <div class="form-group">
		                                                <label for="icode" class="col-md-2 control-label">Body</label>
		                                                <div id = "feedbackbody" class="col-md-10">
		                                                    <textarea rows="10" id="advisorbodyemail"  name="body"  style="width:100%;"></textarea>                                   
		                                                </div>
		                                            </div>
		                                             <div class="form-group">
		                                                <label for="icode" class="col-md-2 control-label">Attach File</label>
					                        ...
					                        <form >
						                        ...
						                        <div class="panel-footer">
						                            <div class="input-group">
						                                <input  id ="advisormessage" onkeypress="checkkey(event)" type="text" class="form-control input-sm" name="advisormessage" placeholder="Type your message here..." />
