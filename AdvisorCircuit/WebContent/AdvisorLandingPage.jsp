  ...
  <c:choose>
  	<c:when test="${service.equals('CareerTalk')}">
 		<jsp:include flush="true" page="Header.jsp">
		    <jsp:param name="title" value="Career talk - Get career counselling online | Advisor Circuit"/>
		 </jsp:include>
  	</c:when>
  	<c:when test="${service.equals('MockInterview')}">
  		 <jsp:include flush="true" page="Header.jsp">
		   		    <jsp:param name="title" value="Mock Interview - Learn how to prepare for an interview | Advisor Circuit"/>
		  	</jsp:include>
  	</c:when>
  	<c:when test="${service.equals('CVCritique')}">
 			<jsp:include flush="true" page="Header.jsp">
		   		    <jsp:param name="title" value="Critique - How to make a good resume | Advisor Circuit"/>
		  	</jsp:include>
  	</c:when>
  	...
  	<c:otherwise>
  		<jsp:include flush="true" page="Header.jsp">
  			<jsp:param name="title" value="Career Counselling Online | Advisor Circuit"/>
	  	</jsp:include>
  	...
  	<c:set var="services" value="<%=service %>"></c:set>	
		<c:if test="${services.equals('CareerTalk')}">
			...
			<div class="col-md-8 col-md-offset-2 text-center">
				<h2>Career Talk</h2>
				<p>A career talk with an industry expert can help you better understand your 
				own choices for your career. It's an opportunity to connect with an advisor to clarify your doubts that you may
				be having about choosing an industry, understanding more about a particular field, discussing issues you are facing
				on the job and a lot more.</p>
				<h1>Check out the below advisor profiles to choose who you'd want to take a session with!</h1>
				<a href="#" data-toggle="modal" data-target="#heretohelp"><h4>Confused about which advisor to choose? We are here to help.</h4><a>
				<div class="hode"><a href="#menu-toggle" class="btn btn-default" id="menu-toggle">Show/Hide Filters</a></div>
			</div>
		</div>
        <!-- /row -->
		</c:if>
		...
		<c:if test="${services.equals('CVCritique')}">
			...
			<div class="col-md-8 col-lg-offset-2 text-center">
				...
				<p>Resume Critique involves an industry expert analyzing your resume and giving 
				feedback to give you an opportunity to understand how a recruiter perceives the same. Get in touch with actual recruiters, 
				headhunters and corporate insiders to know more about your strengths, weaknesses and areas of improvement. Work with them to 
				help build a strong front for your applications.</p>
				<h1>Check out the below advisor profiles to choose who you'd want to take a session with!</h1>
				<a href="#" data-toggle="modal" data-target="#heretohelp"><h4>Confused about which advisor to choose? We are here to help.</h4><a>
				<div class="hode"><a href="#menu-toggle" class="btn btn-default" id="menu-toggle">Show/Hide Filters</a></div>
			</div>
		...
		<c:if test="${services.equals('MockInterview')}">
			...
			<div class="col-md-8 col-lg-offset-2 text-center">
				...
				<p>Mock interview lets you experience a practice interview which is conducted by an 
				expert from your field. It's a great way to get an idea of how an interviewer forms his questions, his assessment of your answers
				and personality. Work with your advisor to get a sneak peek into your interviewer's mind and learn how to tackle tricky
				questions and answer queries in an impressive way.</p>
				<h1>Check out the below advisor profiles to choose who you'd want to take a session with!</h1>
				<a href="#" data-toggle="modal" data-target="#heretohelp"><h4>Confused about which advisor to choose? We are here to help.</h4><a>
				<div class="hode"><a href="#menu-toggle" class="btn btn-default" id="menu-toggle">Show/Hide Filters</a></div>
			</div>
		...
		<c:if test="${services.equals('All')}">
			...
			<div class="col-md-8 col-lg-offset-2 text-center">
				<h2>Our Advisors</h2>
				<p>We have diverse professionals from different industries who can help you grow 
				in your career and excel in your field. Ask them any and every career related query you may have; they are availble for sessions 
				through phone, email and web chat. So go ahead, book a session and take advantage of our advisors' years of experience!</p>
				<h1>Check out the below advisor profiles to choose who you'd want to take a session with!</h1>
				<a href="#" data-toggle="modal" data-target="#heretohelp"><h4>Confused about which advisor to choose? We are here to help.</h4><a>
				<div class="hode"><a href="#menu-toggle" class="btn btn-default" id="menu-toggle">Show/Hide Filters</a></div>
			</div>
		...
		<c:when test="${(services).equals('PersonalWorkshop')}">
			<div class="row workscope">
				<div class="col-md-8 col-lg-offset-2 text-center">
					...
					<p>A personal workshop is a way for you to understand and learn key skills that
					experts have acquired over the years and in turn use them to further your career. Let the expert take you through a topic and 
					teach you certain skills that they think are important for career development. You're even assessed in the end to determine 
					how much you've learnt!</p>
        ...
        <div class="row users-list">
        		...
        		<div id="sidebar-wrapper">
           	    <h4>Industries</h4>
            		<ul class="sidebar-nav list-unstyled">
                		<li>
                        	<label class="filter_lab">
					  		<input id="IndustryTeaching" onchange="CreateFilterParameter(this)" type="checkbox" style="width:25px;">Teaching
					 		</label>
                        </li>
						<li>
                    		<label class="filter_lab">
					  		<input id="IndustryArchitecture" onchange="CreateFilterParameter(this)" type="checkbox" style="width:25px;">Architecture
					 		</label>
                        </li>
						<li>
					 		<label class="filter_lab">
					  		<input id="IndustryTV" onchange="CreateFilterParameter(this)" type="checkbox" style="width:25px;">TV, Media & Film
					 		</label>
						</li>
						<li>
                    		<label class="filter_lab">
					  		<input id="IndustryLaw" onchange="CreateFilterParameter(this)" type="checkbox" style="width:25px;">Law
					 		</label>
						</li>
						<li>
                    		<label class="filter_lab">
					  		<input id="IndustryManagementConsulting" onchange="CreateFilterParameter(this)" type="checkbox" style="width:25px;">Management Consulting
					 		</label>
						</li>
						<li>
                    		<label class="filter_lab">
					  		<input id="IndustryMedicine" onchange="CreateFilterParameter(this)" type="checkbox" style="width:25px;">Medicine
					 		</label>
						</li>
				 		<li>
                    		<label class="filter_lab">
					  		<input id="IndustryLanguageLearning" onchange="CreateFilterParameter(this)" type="checkbox" style="width:25px;">Language Learning
					 		</label>
						</li>
					</ul>
                    ...
                    <ul class="sidebar-nav list-unstyled">
						<li>
                    		<label class="filter_lab">
					  		<input id="Servicecareertalk" onchange="CreateFilterParameter(this)" type="checkbox" style="width:25px;">Career Talk		
					 		</label>
						</li>
						<li>
					 		<label class="filter_lab">
					  		<input id="Servicecvcritique" onchange="CreateFilterParameter(this)" type="checkbox" style="width:25px;">Resume Critique 
					 		</label>
						</li>	 
						<li>
                    		<label class="filter_lab">
					  		<input id="Servicemockinterview" onchange="CreateFilterParameter(this)" type="checkbox" style="width:25px;">Mock Interview
					 		</label>
						</li>
						<li>
                    		<label class="filter_lab">
					  		<input id="Servicepersonalworkshops" onchange="CreateFilterParameter(this)" type="checkbox" style="width:25px;">Personal Workshop
							</label>
						</li>	 
                	</ul>
                    ...
                    <ul class="sidebar-nav list-unstyled">
                    	<li>
                    		<label class="filter_lab">
					  		<input id="Experience5" onchange="CreateFilterParameter(this)" type="checkbox" style="width:25px;">0-5 Years
					 		</label>
						</li>
						<li>
					 		<label class="filter_lab">
					  		<input id="Experience10" onchange="CreateFilterParameter(this)" type="checkbox" style="width:25px;">5-10 Years
					 		</label>
						</li>
						<li>
                    		<label class="filter_lab">
					  		<input id="Experience15" onchange="CreateFilterParameter(this)" type="checkbox" style="width:25px;">>10 Years
					 		</label>
						</li>
					</ul>
                    ...
                    <ul class="sidebar-nav list-unstyled">
						<li>
                    		<label class="filter_lab">
					  		<input id="Modephone" onchange="CreateFilterParameter(this)" type="checkbox" style="width:25px;">Phone
					 		</label>
						</li>
						<li>
					 		<label class="filter_lab">
					  		<input id="Modeemail" onchange="CreateFilterParameter(this)" type="checkbox" style="width:25px;">Email
					 		</label>
						</li>
						<li>
                    		<label class="filter_lab">
					  		<input id="Modewebchat" onchange="CreateFilterParameter(this)" type="checkbox" style="width:25px;">Webchat
					 		</label>
						</li>
            		</ul>
                </div>
			...
			<div class="col-md-10">
				...
				<ul id="gallary">
					...
					<c:when test="${advisors.size() > 0 && advisorservice.size() > 0}">
						...
						<div class="col-md-6" id="advisor">
							...
							<div class="row">
								...
								<c:set var="str" value="${str.concat(advisor.getAdvisorId())}"></c:set>
                                
								<div class="col-md-6 col-xs-6 user-pic">
									<a href="${id}"><img src="${advisor.getImage()}" alt="" height="165"></a>
								</div>
								...
								<div class="col-md-6 col-xs-6 user-detail">
                                    <div class="prof">
										...
										<h4 class="name"><a href="${id}"><c:out value="${advisor.getName()}"></c:out></a></h4>
										<h4 class="industry"><a href="${id}"><c:out value="${advisor.getIndustry()}"></c:out></a></h4>
										<c:set var="doneLoop" value="false"/>
										<c:forEach var="profession" items="${professions}">
											<c:if test="${advisor.getAdvisorId() == profession.getAdvisorId() && not doneLoop }">
												<p><a href="${id}"><c:out value="${profession.getDesignation()}"></c:out></a><br>
												<a href="${id}"><c:out value="${profession.getCompany()}"></c:out></a></p>
                            ...
                            <div class="row">
                                <div class="col-md-12 desc">
                                    <p><a href="${id}"><c:out value="${advisor.getIntroduction()}..."></c:out></a></p>
                                </div>
                                        ...
                                        <c:forEach var="service" items="${advisorservice}">
                                            <c:if test="${service.getAdvisorId() == advisor.getAdvisorId()}">
                                                ...
                                                <c:if test="${service.getService().equals('careertalk') }">
                                                    <div class="col-md-3 col-xs-3 text-center" id="image">
					...
					<c:otherwise>
						<h4 style="font-style:solid"><c:out value="Sorry there are no advisors that match your search. 
						Please try a different keyword or click here to view all our advisors."></c:out></h4>
					</c:otherwise>
				</c:choose>
			</ul>	
            	</li>
