                ...
                <div id="part4">	
                    <ul class="tab-list">
                        ...
                        <c:choose>
                            <c:when test="${professionalBackground.size() > 0 }">
                                ...
                                <div class="form-group" id="dexperience">
                                    ...
                                    <div class="col-md-5">
                                        <input id="experience" type="text"  class="form-control" name="experience" placeholder="" value="${experience}">
                                        <p class="required" id="required_experience">Field Required</p>																			                                        
                                        <p class="required" id="invalid_experience">Invalid Required</p>	 
                                    </div>	
                                </div>	
                                    ...
                                    <c:forEach var="prof" items="${professionalBackground}">
                                        <c:if test="${prof.getCompany() != null}">
                                                ...
                                                <div class="col-md-5">
                                                    <input id="company${counter}" type="text"  class="form-control" name="company[]" placeholder="" value="${prof.getCompany()}">
                                                ...
                                                <div class="form-group" id="dduration${counter}">
                                                    ...
                                                    <div class="col-md-5">
                                                        <input id="duration${counter}" type="text" class="form-control" name="duration[]" placeholder="" value="${prof.getDuration()}">
                                                ...
                                                <div class="form-group" id="ddesignation${counter}">
                                                    ...
                                                    <div class="col-md-5">
                                                        <input id="designation${counter}" type="text" class="form-control" name="designation[]" placeholder="" value="${prof.getDesignation()}">
                                                 ...
                                                 <c:forEach var="desc" items="${prof.getDescriptionArray()}">
                                                    <c:if test="${!desc.isEmpty() && !desc.equals('') && desc.length()> 0}">
                                                         <div class="form-group" id="ddescription${counter}">
                                                            ...
                                                            <div class="col-md-5">
                                                                <input id="description${counter}" class="form-control" name="description${counter}[]" value="${desc}" maxlength="400">
                        ...
                        <div id="ProfessionalBackground0">
                            ...
                            <label for="icode" class="col-md-3 control-label">Experience In  Relevant Industry</label>
                            <div class="col-md-5">
                                <input id="experience" type="text"  class="form-control" name="experience" placeholder="">
                                <p class="required" id="required_experience">Field Required</p>																			                                        
                                <p class="required" id="invalid_experience">Invalid Required</p>	 
                            </div>	
                            </div>
                            ...
                            <label for="icode" class="col-md-3 control-label">Organisation</label>
                            <div class="col-md-5">
                                <input id="company0" type="text"  class="form-control" name="company[]" placeholder="">
                            ...
                            <div class="form-group" id="dduration0">
                                <label for="icode"  class="col-md-3 control-label">Duration</label>
                                <div class="col-md-5">
                                    <input id="duration0" type="text" class="form-control" name="duration[]" placeholder="">
                            ...
                            <div class="form-group" id="ddesignation0">
                                <label for="icode" class="col-md-3 control-label">Designation</label>
                                <div class="col-md-5">
                                    <input id="designation0" type="text" class="form-control" name="designation[]" placeholder="">
                            ...
                            <div class="form-group" id="ddescription0">
                                <label for="icode" class="col-md-3 control-label">Description(Explain your work in bullet points)</label>
                                <div class="col-md-5">
                                    <input id="description0" class="form-control" name="description0[]" maxlength="400">
