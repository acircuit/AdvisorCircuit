                            ...
                            <c:when test="${advisorServices.size()> 0 &&  advisorModes.size()>0}">
                                ...
                                <c:forEach var="service" items="${advisorServices}">
                                    <c:if test="${service.getService().equals('careertalk')}">
                                                ...
                                                <div class="form-group" id="dcareerTalk_description">
                                                    ...
                                                    <div class="col-md-7">
                                                        <textarea id="careerTalk_description"  name="careertalkdescription" style="width:100%;">${service.getDescription()}</textarea> 
                                                ...
                                                <c:forEach var="mode" items="${advisorModes }">
                                                    <c:if test="${mode.getAdvisorId() == service.getAdvisorId() && mode.getService() == service.getService() }">
                                                        <div class="form-group" id="dcareerTalk_mode">
                                                            <div class="col-md-3">
                                                            <label for="icode" class="control-label" style="padding-top:0;">Mode Communication</label>
                                                            </div>
                                                            <div class="col-md-7">
                                             ...
                                             <c:if test="${service.getService().equals('mockinterview')}">
                                                 ...
                                                 <div id="collapseTwo" class="panel-collapse collapse">
                                                    ...
                                                    <div class="form-group" id="dmockInterview_description">
                                                       ...
                                                       <div class="col-md-5">
                                                            <textarea id="mockInterview_description" name="mockinterviewdescription" style="width:100%;">${service.getDescription() }</textarea> 
                                                        </div>
                                                        <div class="col-md-2">	
                                           ...
                                           <c:set value="false" var="cv"></c:set>
                                            ...
                                            <div class="form-group" id="dcvCritique_description">
                                                ...
                                                <div class="col-md-5">
                                                    <textarea id="cvCritique_description" name="cvcritiquedescription" style="width:100%;">${service.getDescription()}</textarea>  
                                ...
                                <c:if test="${ct == 'true' }">
                                        ...
                                        <div id="collapseOne" class="panel-collapse collapse">
                                            ...
                                            <div class="form-group" id="dcareerTalk_description">
                                                ...
                                                <div class="col-md-5">
                                                    <textarea id="careerTalk_description"  name="careertalkdescription" style="width:100%;"></textarea> 
                                            ...
                                            <div class="form-group" id="dcareerTalk_mode">
                                                <div class="col-md-3">
                                                <label for="icode" class="control-label">Mode Communication</label>
                                                </div>
                                                <div class="col-md-8">
                                ...
                                <c:if test="${mi =='true' }">
                                            ...
                                            <div class="form-group" id="dmockInterview_description">
                                               ...
                                               <div class="col-md-7">
                                                    <textarea id="mockInterview_description" name="mockinterviewdescription" style="width:100%;"></textarea> 
                                                </div>
                                                <div class="col-md-2">	
                                                            <button type="button" class="btn btn-default" data-html=" " data-container="body" data-trigger="focus" data-toggle="popover" data-placement="right"  data-content="Example: I have conducted interviews and recruited over 50 individuals for various positions and feel confident that I can give you a close to reality interview experience">
                                                            <span class="glyphicon glyphicon-info-sign" aria-hidden="true"></span> </button>
                                    ...
                                    <c:if test="${cv =='true' }">
                                        ...
                                        <div id="collapseThree" class="panel-collapse collapse">
                                            ...
                                            <div class="form-group" id="dcvCritique_description">
                                                ...
                                                <div class="col-md-7">
                                                    <textarea id="cvCritique_description" name="cvcritiquedescription" style="width:100%;"></textarea>  
                            ...
                            <div class="col-md-10">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-offset-3 col-md-9">
                                        <button id="btn-signup" style="float: right" type="submit" class="btn btn-info">Submit and Continue</button>
                                    </div>
                                 </div>			
                            </div>
                    </form>									                                
