                                	...
                                	<c:choose>
                                			...
                                			<c:set var="counter" value="0"></c:set>
                                				<c:forEach var="achievement" items="${achievements}">
	                                				<div class="form-group" id="daward">
					                                    ...
					                                    <div class="col-md-5">
					                                        <input id="award${counter}" class="form-control" name="achievement[]" value="${achievement.getAchievements() }" >
                                		...
                                		<c:forEach var="skill" items="${keySkill}">
                                			<div class="form-group" id="dskill">
			                                    ...
			                                    <div class="col-md-5">
			                                        <input id="skill${skillcounter}" class="form-control" name="keyskills[]" value="${skill.getKeyskill()}">  
