                        ...
                        <c:if test="<%= path != null && path.length()>5 %>">
                            <div class="form-group">
                                ...
                                <c:if test="${(!fromCancelledSession && visible) || fromPreviousSession}">
                                    <a class="btn btn-info margin-10" data-toggle="modal" data-target="#feedback" onclick="">Send Your Follow Up Mail</a>
                                </c:if>
					                        ...
					                        <form >
						                        ...
						                        <div class="panel-footer">
						                            <div class="input-group">
						                                <input  id ="usermessage" onkeypress="checkkey(event)" type="text" class="form-control input-sm" name="usermessage" placeholder="Type your message here..." />
                                	...
                                	<c:otherwise>
                                        ...
                                        <div class="form-group text-left">
                                            ...
                                            <div id = "feedbackbody" class="col-md-10">
                                                <textarea rows="10" id="body"  name="body"  style="width:100%"></textarea>                                   
                                            </div>
                                        </div>
	                                 <div class="form-group text-left">
	                                    <label for="icode" class="col-md-2 control-label">Attach File</label>
                                	...
                                	<c:when test="${emailUser != null && emailUser.getId() != 0 }">
			                                ...
			                                <c:when test="<%=isEmailRejected != null && !isEmailRejected &&  (fromPreviousSession == null || !fromPreviousSession)%>">
				                                    ...
				                                    <div id = "emailsubject" class="col-md-9">
														<input type="text" id="subjectemail" name="subject" style="width: 80%" value="${emailUser.getUserSubject()}">
				                                    </div>
				                                </div>
				                                <div class="form-group">
				                                    <label for="icode" class="col-md-3 control-label">Body</label>
				                                    <div id = "emailbody" class="col-md-9" style="width: 100px">
				                                    	<textarea rows="15" cols="90" id="bodyemail"  name="body" >${emailUser.getUserBody()}</textarea>                                   
				                                    </div>
				                                </div>
                                	...
                                	<c:otherwise>
                                		...
                                		<div class="form-group text-left">
                                            ...
                                            <div id = "emailsubject" class="col-md-10">
                                                <input type="text" id="subjectemail" name="subject"  style="width:100%">
                                            </div>
	                                	</div>
                                        <div class="form-group text-left">
                                            <label for="icode" class="col-md-2 control-label">Body</label>
                                            <div id = "emailbody" class="col-md-10">
                                                <textarea rows="10" id="bodyemail"  name="body"  style="width:100%"></textarea>                                   
                                            </div>
                                        </div>
	                                 <div class="form-group text-left">
	                                    <label for="icode" class="col-md-2 control-label">Attach File</label>
