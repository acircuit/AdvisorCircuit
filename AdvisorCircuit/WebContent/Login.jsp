                            ...
                            <div style="margin-bottom: 25px" class="input-group" id="dlogin-password">
                              ...
                              <div>
                              	<c:if test="<%=isLoginFailedFromProfile %>">
                               		<c:out value="Please Login as a user"></c:out>
                               </c:if>
                              	<c:if test="${isLoginFailed == true}">
                              		<c:out value="Your login details are invalid. Did you select the right account?"></c:out>
                              	</c:if>
                              </div>      
								...
								<div class="modal-body">
									<form id="signupform" class="form-horizontal" role="form" enctype="multipart/form-data"  action="UserRegistration" method="post" >
										...
										<div class="form-group" id="dconfirm-password">
											...
											<div class="col-md-9">
												<input id="confirm-password" type="password" class="form-control" name="confirmpasswd" placeholder="Confirm Password">
											</div>
											<div class="col-md-9">
										...
										<div class="form-group" id="dorg">
											...
											<div class="col-md-9">
												<textarea id="org" class="form-control" name="occupation" rows="3"></textarea>
											</div>
											<div class="col-md-9">
										...
										<div class="form-group">
											...
											<div class="col-md-offset-3 col-md-9">
								   				<input type="checkbox" id="agree" name="agree"><span style="padding: 1%">I agree with the <a href="terms">Terms & Conditions.</a></span>  
