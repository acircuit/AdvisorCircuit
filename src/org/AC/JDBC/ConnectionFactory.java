...
public class ConnectionFactory {
	...
	private ConnectionFactory() throws IOException, SQLException,
		...
		comboPooledDataSource.setDriverClass(prop
		...
		comboPooledDataSource
				.setPassword(prop.getProperty("MYSQL_DB_PASSWORD"));

		// DB Tunning : You can set more, read it online
		comboPooledDataSource.setMinPoolSize(Integer.parseInt(prop
				.getProperty("CON_POOL_MIN_SIZE")));
		comboPooledDataSource.setMaxPoolSize(Integer.parseInt(prop
				.getProperty("CON_POOL_MAX_SIZE")));
