...
public class MsgAndFileDTO implements Comparable<MsgAndFileDTO> {
	...
	public MsgAndFileDTO(String timeStampStr, String message, String msgType,
			String sender, Timestamp messageTime) {
	...
	public String toString() {
		...
		if (this.getSender().equalsIgnoreCase("advisor")) {
			data = "<li class='left clearfix'><span class='chat-img pull-left'><i class='glyphicon glyphicon-user red'></i></span><div class='chat-body clearfix' style='margin-left:0px'>"
					...
					+ this.getTimeStampStr()
					+ "</i></small></div><p>"
					+ this.getMessage() + "</p></div></li>";
			...
			data = "<li class='left clearfix'><span class='chat-img pull-right'><i class='glyphicon glyphicon-user'></i></span><div class='chat-body clearfix' style='margin-left:0px'><div class='header'>"
					+ "<small ><i class='fa fa-clock-o fa-fw gray' style='width:inherit; font-size:12px'>"
					+ this.getTimeStampStr()
					+ "</i></small><strong class='pull-right primary-font'>User</strong></div>"
					+ "<p class = 'pull-right'>"
					+ this.getMessage()
					+ "</p></div></li>";
		}
		...
		//
		// data =
		// "<li class='left clearfix'><span class='chat-img pull-right'><i class='glyphicon glyphicon-user "+color+"'></i></span><div class='chat-body clearfix' style='margin-left:0px'><div class='header'>"
		// +
