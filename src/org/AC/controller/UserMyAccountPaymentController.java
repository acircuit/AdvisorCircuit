		...
		if(sId!= null && rId != null && acceptedDate == null){
			...
			if(isStatusCommit){
				...
				if(isSessionStatus){
					...
					String content = "Hi, <br><br>User Payment Done For Session Id : "+sId+" <br>Now, Waiting for session to happen"+"<br><img src=\"http://www.advisorcircuit.com/Test/assets/img/logo_black.png\" style='float:right' width='15%'>";
