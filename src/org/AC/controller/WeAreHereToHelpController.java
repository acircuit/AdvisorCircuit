	...
	protected void doPost(HttpServletRequest request,
		...
		if( email != null && phone != null && !email.isEmpty() && !phone.isEmpty()){
			...
			if(isDetailsCommit){
				...
				content = "Hi, <br><br>A new user has filled in details for We are here to help.Following are the details :  <br> Email :"
						+ email
				...
				mail.start();
				response.getWriter()
						.write("Thank you, we'll reach out to you within a day.");
			}
