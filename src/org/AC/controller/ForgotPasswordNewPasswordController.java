...
/**
 * Servlet implementation class ForgotPasswordLoginController This servlet
 * retrieves the form fields of the Login.jsp and authenticate the user.
 */
...
public class ForgotPasswordNewPasswordController extends HttpServlet {
	...
	private static final Logger logger = Logger
			.getLogger(ForgotPasswordNewPasswordController.class);
	...
	protected void doPost(HttpServletRequest request,
		...
		try {
			...
			logger.error("doPost method of ForgotPasswordNewPasswordController threw error:"
					+ e.getMessage());
			e.printStackTrace();
		}
