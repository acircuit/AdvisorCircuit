...
public class AdvisorEditOtherinfoController extends HttpServlet {
	...
	private static final Logger logger = Logger
			.getLogger(AdvisorEditOtherinfoController.class);
		...
		if (advisorId != 0) {
			...
			if (keySkill.size() > 0) {
				...
				RequestDispatcher rd = getServletContext()
						.getRequestDispatcher("/OtherInfo.jsp");
		...
		if (aId != 0) {
			if (keyskills.length > 0) {
				...
				if (isSkillCommit) {
					...
					String comment = advisorName + "with Id = "+aId+" edited his other info ";
					...
					content = "Hi, <br><br>An Advisor just edited his profile. Following are the details: <br> Advisor Id : "
							+ aId
							+ "<br>Section : Other Info <br><img src=\"https://www.advisorcircuit.com/Test/assets/img/logo_black.png\" style='float:right' width='25%'>";
