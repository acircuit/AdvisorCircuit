...
public class UserNotificationSSE extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        for (NotificationDTO notificationDTO : notify) {
			data = data + "<li style='color:#ffffff'><a href='"+notificationDTO.getHref()+"'>"+notificationDTO.getComment()+"</a><span class='date'>"+new SimpleDateFormat("dd-MMM-yyyy' 'h:mm a").format(new Date(notificationDTO.getDate().getTime()))+"</span><hr></li>";
