		 ...
		 if(advisorId != 0 && advisorMessage != null && !("").equals(advisorMessage)){
			 ...
			 if(time != null){
				 ...
				 if(advisorId != 0  && !("").equals(advisorEmail) && !("").equals(advisorName)){
						...
						String content ="Hi, <br><br> An Advisor has sent a message to admin. Following are the details: <br>Message By : " +advisorName+ "<br>Email Id: " +advisorEmail+ "<br>Advisor Id: " +advisorId+ "<br>Message: " +advisorMessage+"<br><img src=\"https://www.advisorcircuit.com/Test/assets/img/logo_black.png\" style='float:right' width='15%'>";
