...
public class AdminAdvisorsController extends HttpServlet {
	...
	private static final Logger logger = Logger
			.getLogger(AdminAdvisorsController.class);
	...
	protected void doPost(HttpServletRequest request,
		...
		if (operation.equalsIgnoreCase("updatePriorityLevel")) {
			int updatedPriorityLevel = Integer.parseInt(request
					.getParameter("updatedPriorityLevel"));
			...
			int advisorId = Integer.parseInt(request.getParameter("advisorId"));
			String noOfFreeSessionsCT = request
					.getParameter("noOfFreeSessionsCT");
			String noOfFreeSessionsMI = request
					.getParameter("noOfFreeSessionMI");
			String noOfFreeSessionsRC = request
					.getParameter("noOfFreeSessionsRC");
			Boolean isAdmin = false;
			Boolean isError = false;
			try {
				isAdmin = (Boolean) request.getSession().getAttribute("admin");
			...
			int discountCT = Integer.parseInt(request
					.getParameter("discountCT"));
			int discountMI = Integer.parseInt(request
					.getParameter("discountMI"));
			int discountRC = Integer.parseInt(request
					.getParameter("discountRC"));
			Boolean isAdmin = false;
			Boolean isError = false;
			try {
				isAdmin = (Boolean) request.getSession().getAttribute("admin");
