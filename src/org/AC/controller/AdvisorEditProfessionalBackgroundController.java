...
public class AdvisorEditProfessionalBackgroundController extends HttpServlet {
	...
	private static final Logger logger = Logger.getLogger(AdvisorEditProfessionalBackgroundController.class); 
			...
			if(company.length > 0  && designation.length > 0 && duration.length > 0) {
				...
				if(isDescriptionCommit){
					Properties prop = new Properties();
					 ...
					 content = "Hi, <br><br>An Advisor just edited his profile. Following are the details: <br> Advisor Id : "+aId+"<br>Section : Professional Background<br><img src=http://www.advisorcircuit.com/assets/img/logo_black.png\" style='float:right' width='25%'>";
