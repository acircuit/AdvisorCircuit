		...
		if( cancel == null ){
			...
			if(isStatusCommit && sessionId != null){
				...
				if(isSessionStatusCommit){
					...
					String content = "Hi, <br><br>The Session was rejected by the user for Session Id : "+sessionId+ " and Request Id :"+rId1+"<br><img src=\"https://www.advisorcircuit.com/Test/assets/img/logo_black.png\" style='float:right' width='15%'>";
				...
				admin.InsertNotification(adminComment, adminHref);
				String subject = "Session Rejected By User!";
				String content = "Hi, <br><br>The Session was rejected by the user for Request Id :"+rId1+"<br><img src=\"https://www.advisorcircuit.com/Test/assets/img/logo_black.png\" style='float:right' width='15%'>";
				SendMail mail = new SendMail(subject, content, prop.getProperty("MAIL_ADMIN"),prop.getProperty("MAIL_ADMIN"));
				mail.start();
				response.sendRedirect("UserCancelledSessions");
			}
