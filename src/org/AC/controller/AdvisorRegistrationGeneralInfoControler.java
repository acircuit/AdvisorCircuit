...
public class AdvisorRegistrationGeneralInfoControler extends HttpServlet {
	...
	private static final Logger logger = Logger
			.getLogger(AdvisorRegistrationGeneralInfoControler.class);
			...
			if (fromTab != null && fromTab.equals("true")) {
				...
				if (profile.getName() != null) {
					...
					RequestDispatcher rd = getServletContext()
							.getRequestDispatcher("/GeneralInfo");
	 ...
	 *      response) This method will retrieve the general info from the form
			...
			if (name != null && gender != null && age != null && city != null
				...
				if (advisorId != 0) {
					...
					if (edit != null && edit.equals("true")) {
						isGeneralInfoCommit = dao.setGeneralInfo(name, gender,
								age, city, phone, industry, intro, advisorId,
								state, edit);
					} else {
						edit = "false";
						isGeneralInfoCommit = dao.setGeneralInfo(name, gender,
