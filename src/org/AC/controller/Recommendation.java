					...
					String reviewMessageStatus = reviewMessages.getReviewMessageStatus();
						if(ratings && (reviewMessage != null && !reviewMessageStatus.equals("REJECTED"))){
							...
							if(isReviewCommit){
								...
								content = "Hi, <br><br>An advisor just got reviewed. Following are the details : <br> For SessionId : " +sId+ "<br>Review Message : " +reviewmessage+"<br><img src=\"http://www.advisorcircuit.com/Test/assets/img/logo_black.png\" style='float:right' width='15%'>";
