		...
		if(sId != null && type == null && details== null ){
			...
			if(isApproved){
				...
				if(isFeedbackFormCommit){
					...
					String content1 = "Hi,<br> An Advisor gave "+service+ "feedback. Following are the details: <br>Session Id : "+sId+"<br><img src=\"http://www.advisorcircuit.com/Test/assets/img/logo_black.png\" style='float:right' width='25%'>";
