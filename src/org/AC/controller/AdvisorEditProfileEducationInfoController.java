...
public class AdvisorEditProfileEducationInfoController extends HttpServlet {
	...
	private static final Logger logger = Logger
			.getLogger(AdvisorEditProfileEducationInfoController.class);
		...
		if (aId != 0) {
			if (education.length > 0) {
				...
				if (isEducationInfoCommit) {
					...
					String comment = advisorName + "with Id = "+aId+" edited his education info ";
					...
					content = "Hi, <br><br>An Advisor just edited his profile. Following are the details: <br> Advisor Id : "
							+ aId
							+ "<br>Section : Education Info <br><img src=\"https://www.advisorcircuit.com/Test/assets/img/logo_black.png\" style='float:right' width='25%'>";
