...
public class MyAccountRequestDAO {
	...
	public String getCvPath(String requestId){
		...
		try {
			...
			try {
				...
				logger.error("getCvPath method of MyAccountRequestDAO threw error:"+e.getMessage());
				e1.printStackTrace();
			}
			logger.error("getCvPath method of MyAccountRequestDAO threw error:"+e.getMessage());
			e.printStackTrace();
	...
	public String GetFeedbackPathForUser(int sId){
		...
		try {
			...
			logger.error("GetFeedbackPathForUser method of MyAccountRequestDAO threw error:"+e.getMessage());
			e.printStackTrace();
		} catch (IOException e) {
			logger.error("GetFeedbackPathForUser method of MyAccountRequestDAO threw error:"+e.getMessage());
			e.printStackTrace();
	...
	public String GetModeDetails(int sId){
		...
		try {
			...
			logger.error("GetModeDetails method of MyAccountRequestDAO threw error:"+e.getMessage());
			e.printStackTrace();
		} catch (IOException e) {
			logger.error("GetModeDetails method of MyAccountRequestDAO threw error:"+e.getMessage());
			e.printStackTrace();
